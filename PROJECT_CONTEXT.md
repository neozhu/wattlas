...
- Local candidate snapshot `2026-07-21T04-48-33Z`, which retains the preceding 4,247 data centres, 101 water assets, 238,395 power-source records, 3,229 ADM1 boundaries, 575 cities, and 60,600 grid features while adding 7,694 mappable industrial-load assets, 27 mappable hydrogen-network context assets, and 236 unique project-evidence-eligible industrial projects. Of these, 233 are applied across 137 supported ADM1 forecasts; three steel increments in Albania and Namibia remain visible but unapplied because their regional demand baselines are explicitly unavailable.
